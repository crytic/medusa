...
contract TestContractChild {
    ...
    function invariant_failing_property_test_method_child() public view returns (bool) {
        return false;
    }
}
...
contract TestContract {
    ...
    function invariant_failing_property_test_method() public view returns (bool) {
        return false;
    }
}
